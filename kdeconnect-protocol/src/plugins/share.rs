//! Share Plugin
//!
//! Facilitates file, text, and URL sharing between KDE Connect devices.
...
//!
//! ```rust,ignore
//! use kdeconnect_protocol::plugins::share::*;
//! use kdeconnect_protocol::{Plugin, PluginManager};
//!
...
///
/// ```rust
/// use kdeconnect_protocol::plugins::share::FileShareInfo;
///
...
///
/// ```rust
/// use kdeconnect_protocol::plugins::share::MultiFileInfo;
///
...
///
/// ```rust
/// use kdeconnect_protocol::plugins::share::SharePlugin;
...
impl SharePlugin {
    ...
    ///
    /// ```rust
    /// use kdeconnect_protocol::plugins::share::{SharePlugin, FileShareInfo};
    ///
    /// let plugin = SharePlugin::new();
    /// let file_info = FileShareInfo {
    ...
    ///
    /// ```rust
    /// use kdeconnect_protocol::plugins::share::{SharePlugin, MultiFileInfo};
    ///
    /// let plugin = SharePlugin::new();
    /// let info = MultiFileInfo {
    ///     number_of_files: 5,
